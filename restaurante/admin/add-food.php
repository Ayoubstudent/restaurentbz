                 ...
                 <form action="" method="POST" enctype="multipart/form-data">
                      ...
                      <table class="tbl-30">
                          ...
                          <tr>
                              ...
                              <td>Category:</td>
                                 ...
                                 <?php
                                            ...
                                            <option value="0">Not Category Found.</option>
                          ...
                          <tr>
                               <td>Featured :</td>
                               <td>
                                    <input type="radio" name="fuatured" value="Yes">Yes
                                    <input type="radio" name="fuatured" value="No">No
                               </td>
